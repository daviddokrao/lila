...
final class UserList(helpers: Helpers, bits: UserBits):
  ...
  def bots(users: List[UserWithPerfs], bestPerfs: UserPerfs => List[PerfKey])(using Context) =
    ...
    val aboutLink = a(href := "/blog/WvDNticAAMu_mHKP/welcome-lichess-bots")("About HungKings Bots")
        ...
        main(cls := "page-menu")(
          ...
          div(cls := "bots page-menu__content")(
            ...
            div(cls := "box box-pad bots__categ")(
              ...
              p(
                "More chess engines created by the HungKings community. They are hosted by their creators, and as such might not always be online."
              ),
