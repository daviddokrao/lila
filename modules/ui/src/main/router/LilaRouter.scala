...
object LilaRouter:
  ...
  given PathBindable[UserStr] = strPath[UserStr](UserStr.read, "Invalid HungKings username")
  given PathBindable[PerfKey] = strPath[PerfKey](PerfKey.apply, "Invalid HungKings performance key")
