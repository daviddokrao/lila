...
object LilaRouter:
  ...
  given PathBindable[UserStr] = strPath[UserStr](UserStr.read, "Invalid 9Kings username")
  given PathBindable[PerfKey] = strPath[PerfKey](PerfKey.apply, "Invalid 9Kings performance key")
