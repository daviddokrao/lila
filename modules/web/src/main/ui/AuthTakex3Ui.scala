...
final class AuthTakex3Ui(helpers: Helpers):
    ...
    Page("Sign in")
      ...
      .flag(_.noHeader):
        main(cls := authClasses("auth auth-login box box-pad"))(
          connectionHeader("Login to HungKings"),
          postForm(
            cls := "form3",
    ...
    Page("Create HungKings account")
      ...
      .flag(_.noHeader):
        main(
          ...
          connectionHeader("Create HungKings account"),
          postForm(
            id := "signup-form",
            cls := "form3",
            ...
            small(cls := "form-help")(
              "By registering you accept HungKings' ",
  ...
  def passwordResetConfirm(
    ...
    given Translate = oauthClientLanguage
    val title = "Reset your HungKings password"
    def confirmForm =
      ...
      .flag(_.noHeader):
        main(cls := authClasses("auth auth-password-reset auth-password-reset--success box box-pad"))(
          ...
          p(cls := "auth__reset-copy")(
            "Your HungKings password has been updated. Return to Take Take Take to log in with your new password."
          ),
