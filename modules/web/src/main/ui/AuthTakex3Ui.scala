...
final class AuthTakex3Ui(helpers: Helpers):
    ...
    Page("Sign in")
      ...
      .flag(_.noHeader):
        main(cls := authClasses("auth auth-login box box-pad"))(
          connectionHeader("Login to 9Kings"),
          postForm(
            cls := "form3",
    ...
    Page("Create 9Kings account")
      ...
      .flag(_.noHeader):
        main(
          ...
          connectionHeader("Create 9Kings account"),
          postForm(
            id := "signup-form",
            cls := "form3",
            ...
            small(cls := "form-help")(
              "By registering you accept 9Kings' ",
  ...
  def passwordResetConfirm(
    ...
    given Translate = oauthClientLanguage
    val title = "Reset your 9Kings password"
    def confirmForm =
      ...
      .flag(_.noHeader):
        main(cls := authClasses("auth auth-password-reset auth-password-reset--success box box-pad"))(
          ...
          p(cls := "auth__reset-copy")(
            "Your 9Kings password has been updated. Return to Take Take Take to log in with your new password."
          ),
